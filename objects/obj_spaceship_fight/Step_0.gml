...
if !place_meeting(x + _xd, y, obj_inv_floor) {
    x += _xd;
}
if !place_meeting(x, y + _yd, obj_inv_floor) {
    y += _yd;
}
...
if keyboard_check_pressed(vk_space) {
    ...
    var _tiro = instance_create_layer(x - 7, y - sprite_height / 2, "Instances", obj_bullet);
